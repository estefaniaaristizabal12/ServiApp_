    ...
    return (
        <View style={{ flex: 1, paddingTop, flexDirection: "column", backgroundColor: Colors.grey }}>
            ...
            <View style={{ flex: 0.9, backgroundColor: "white", borderTopLeftRadius: 30, borderTopRightRadius: 30 }}>
                ...
                <TouchableOpacity style={{margin:20, borderRadius:40, borderWidth:0.5, backgroundColor:Colors.grey}}>
                    <Text style={{fontSize:normalize(20), padding:15}}>Ingresa tu nueva ubicación</Text>
                </TouchableOpacity>
