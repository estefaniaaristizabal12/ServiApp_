          ...
          <CustomCard style={{flexDirection:"row",alignItems:"center",backgroundColor:"#fff",borderRadius:15,paddingHorizontal:10,paddingVertical:20}}>
            ...
            <View style={{flex:2,marginLeft:15,marginRight:8}}>
              <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                <Text style={{fontWeight:"600",color:Colors.LIGHTBLACK}}>Pedio</Text>
                <Text>No. 122332</Text>
              </View>
              <View style={{flexDirection:"row",marginTop:5,justifyContent:"space-between"}}>
                <Text style={{color: Colors.LIGHTGREY,fontWeight:"600"}}>{difference}</Text>
                <Text style={{color:decreased?Colors.RED:Colors.GREEN,fontWeight:"600"}}>2121</Text>
              </View>
            </View>
          </CustomCard>
          </Pressable>);
